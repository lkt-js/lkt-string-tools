...
function E(e, r, n = ":", a = "") {
  return Object.keys(r).filter((t) => e.indexOf(n + t + a) > -1);
}
function C(e, r, n = ":", a = "") {
  return Object.keys(r).forEach((o) => {
    e = e.replace(n + o + a, r[o]);
  }), e;
}
function O(e = 10) {
  let r = "";
...
function S(e, r) {
  ...
  return e.replace(a, "").replace(n, function(t, o) {
    return r.indexOf(`<${o.toLowerCase()}>`) > -1 ? t : "";
  });
}
function y(e) {
...
function d(e) {
  ...
  function a(t, o) {
    ...
    var f = n[o.locale] || {}, i = t.normalize().split("").reduce(function(h, c) {
      var u = f[c];
      return u === void 0 && (u = r[c]), u === void 0 && (u = c), h + u.replace(o.remove || /[^\w\s$*_+~.()'"!\-:@]+/g, "");
    }, "");
    return i = i.trim(), o.lower && (i = i.toLowerCase()), i;
  }
...
function N(e, r, n, a) {
  ...
  return t = String(t.replace(".", n)), t = t.replace(/D/g, a), t;
}
function j(e) {
  return decodeURIComponent(
    s(e).replace(/%(?![\da-f]{2})/gi, "%25").replace(/\+/g, "%20")
  );
}
function D(e) {
...
function T(e) {
  let r = "", n = 0, a = 0, t = 0, o = 0;
  for (; n < e.length; )
    a = e.charCodeAt(n), a < 128 ? (r += String.fromCharCode(a), n++) : a > 191 && a < 224 ? (t = e.charCodeAt(n + 1), r += String.fromCharCode((a & 31) << 6 | t & 63), n += 2) : (t = e.charCodeAt(n + 1), o = e.charCodeAt(n + 2), r += String.fromCharCode((a & 15) << 12 | (t & 63) << 6 | o & 63), n += 3);
  return r;
}
export {
  k as cloneString,

function m(e) {
    ...
    let r = "/";
    e.indexOf("C:\\") === 0 && (r = "\\");
    let n = e.substring(e.lastIndexOf(r) + 1);
...
function E(e, r, n = ":", a = "") {
    return Object.keys(r).filter((o) => e.indexOf(n + o + a) > -1);
}
function C(e, r, n = ":", a = "") {
    return Object.keys(r).forEach((t) => {
        e = e.replace(n + t + a, r[t]);
    }), e;
}
function O(e = 10) {
    let r = "";
...
function S(e, r = "") {
    ...
    return e.replace(a, "").replace(n, function (o, t) {
        return r.indexOf(`<${t.toLowerCase()}>`) > -1 ? o : "";
    });
}
function y(e) {
...
function d(e) {
    ...
    function a(o, t) {
        ...
        var c = n[t.locale] || {}, i = o.normalize().split("").reduce(function (h, l) {
            var u = c[l];
            return u === void 0 && (u = r[l]), u === void 0 && (u = l), h + u.replace(t.remove || /[^\w\s$*_+~.()'"!\-:@]+/g, "");
        }, "");
        return i = i.trim(), t.lower && (i = i.toLowerCase()), i;
    }
    return a.extend = function (o) {
        Object.assign(r, o);
    }, a(e, {});
}
...
function Y(e = "") {
    return s(e) && e !== "" && e.indexOf("data:image/") !== -1;
}
function w(e = "") {
...
function N(e, r, n, a, o = !0) {
    let t = String(
    // @ts-ignore
    parseFloat(e).toFixed(r).replace(/\d(?=(\d{3})+\.)/g, "$&D"));
    t = String(t.replace(".", n));
    let c = t.split(n);
    return o && parseInt(c[1]) === 0 && (t = c[0]), t = t.replace(/D/g, a), t;
}
function j(e) {
    return decodeURIComponent(f(e).replace(/%(?![\da-f]{2})/gi, "%25").replace(/\+/g, "%20"));
}
function D(e) {
    return e = e.toLowerCase(), e = g(e, "-"), d(e);
}
function L(e) {
    e = e.replace(/\r\n/g, `
`);
    ...
    for (let n = 0; n < e.length; n++) {
        ...
        a < 128 ? r += String.fromCharCode(a) : a > 127 && a < 2048 ? (r += String.fromCharCode(a >> 6 | 192), r += String.fromCharCode(a & 63 | 128)) : (r += String.fromCharCode(a >> 12 | 224), r += String.fromCharCode(a >> 6 & 63 | 128), r += String.fromCharCode(a & 63 | 128));
    }
    return r;
}
function T(e) {
    let r = "", n = 0, a = 0, o = 0, t = 0;
    for (; n < e.length;)
        a = e.charCodeAt(n), a < 128 ? (r += String.fromCharCode(a), n++) : a > 191 && a < 224 ? (o = e.charCodeAt(n + 1), r += String.fromCharCode((a & 31) << 6 | o & 63), n += 2) : (o = e.charCodeAt(n + 1), t = e.charCodeAt(n + 2), r += String.fromCharCode((a & 15) << 12 | (o & 63) << 6 | t & 63), n += 3);
    return r;
}
export { k as cloneString, j as decodeUrl, E as extractFillData, C as fill, N as formatNumber, O as generateRandomString, m as getBaseName, D as getUrlSlug, y as htmlEntities, Y as isBase64Image, b as isEmail, I as isFilled, s as isString, w as kebabCaseToCamelCase, A as lpad, U as replaceAll, d as replaceNonAsciiChars, g as replaceSingleWhiteSpaces, S as stripTags, f as toString, z as trim, v as ucfirst, T as utf8Decode, L as utf8Encode };
